...
public class SlidingFragmentActivity extends FragmentActivity implements
	...
	protected void onSaveInstanceState(Bundle outState) {
		// super.onSaveInstanceState(outState);//20160111 JS注释
		if (outState == null) {// 20161207 JS新增
			return;
		}
		try {// 20161207 JS新增
			mHelper.onSaveInstanceState(outState);
		} catch (Exception e) {
			Log.e("SlidingFragmentActivity",
					"SlidingFragmentActivity onSaveInstanceState失败,已经捕获");
		}
